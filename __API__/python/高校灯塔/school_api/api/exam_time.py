...
from school_api.exceptions import ExamTimeException
...
class ExamTime:
    ...
    def get_exam_time(self, **kwargs):
        ...
        try:
            ...
            raise ExamTimeException(self.config['code'], '用户考试时间接口已关闭')
        except RequestException:
            raise ExamTimeException(self.config['code'], '获取用户信息失败')
